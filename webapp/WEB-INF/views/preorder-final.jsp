...
<body>
	<div class="container-fluid">
		<div style="margin-top: 5%; text-align: center;">
			<p style="font-size: 24px; margin-bottom: 5px;">Спасибо за предварительный заказ!</p>
			<p style="font-size: 24px; margin-bottom: 5px;">Мы свяжемся с вами в ближайшее время.</p>
