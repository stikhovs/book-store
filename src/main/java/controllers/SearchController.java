...
public class SearchController {
	...
	public String goSearch(Model model, 
		...
		sortMenuItems.put("по названию ј-я", "title,asc");
		sortMenuItems.put("по названию я-ј", "title,desc");
		sortMenuItems.put("по автору ј-я", "author,asc");
		sortMenuItems.put("по автору я-ј", "author,desc");
