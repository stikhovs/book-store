...
<title>Список предзаказов - Sergio Books</title>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div id="admin-menu" class="col-2">
				...
				<nav class="nav flex-column bg-dark"
					...
					<li class="nav-item"><a class="nav-link" href='<spring:url value="/admin/order-list"/>'>Список
							заказов</a></li>
					<li class="nav-item"><a class="nav-link active" href='<spring:url value="/admin/preorder-list"/>'>Список
							предзаказов</a></li>
			...
			<div class="col-10" style="padding-top: 40px;">
				...
				<h3 style="margin: 40px 0;">Список предзаказов</h3>
					...
					<table class="table table-hover">
						...
						<tbody>
							<c:forEach items="${preorderlist}" var="preorder">
								<tr
									data-href='<spring:url value="/admin/preorder-list/edit/${preorder.preorderId}"/>' style="text-align: center;">
									<td>${preorder.preorderId}</td>								
									<td>${preorder.bookId}</td>								
